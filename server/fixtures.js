...
if (Questions.find().count() === 0) {
    Questions.insert({ title: "Las encuestas son buenas siempre?", createdAt: new Date(), usuario:"Jose", duration: 30, idpreguntas: 1, views: 0,status:"active", userID: "CLqcJGr3rNYWXpN3x"});
    Questions.insert({ title: "Cual es mejor deporte?", createdAt: new Date(), usuario:"Maria", duration: 500, idpreguntas: 2, views: 0,status:"active", userID: "CLqcJGr3rNYWXpN3x" });
    Questions.insert({ title: "De que color es el cielo?", createdAt: new Date(), usuario:"Jelen", duration: 0, idpreguntas: 3, views: 0,status:"inactive", userID: "CLqcJGr3rNYWXpN3x" });
